...
# if opt.save_img == int(0):
#     save_img = False
# else:
#     save_img = True
weights, view_img, save_txt, imgsz, trace = './models/final_best.pt', False, True, 640, True
save_img = True
webcam = False
...
while True:
    ...
    if len(os.listdir(image_path)) != 0:
        for i in os.listdir(image_path):
            # while len(os.listdir(os.path.join(image_path,i))) < 20:
            #     print('Putting Input Data')
            if len(os.listdir(os.path.join(image_path,i))) == 20:
                dir_ls.append(os.path.join(image_path,i))
                print('Append ls')
                break
