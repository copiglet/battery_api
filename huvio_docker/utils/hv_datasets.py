...
class HvLoadImages(LoadImages):
    def __init__(self, path, img_size=640, stride=32, fName):
        LoadImages.__init__(self, path, img_size=640, stride=32)
        self.nf = 1
        self.files = [x for fName in self.files]
